...
You can install this plugin from the [ZIP file](https://drive.google.com/file/d/1r-QO-6X8jaXOiMkgR8M4UanwnDqE8dBD/view) as any other plugin. Follow [this instruction](https://wordpress.org/support/article/managing-plugins/#upload-via-wordpress-admin).
